                          ...
                          <div className="contents">
                            ...
                            <div className="product-uniques">
                              ...
                              <span className="catagorys product-unipue mb--10">
                                <strong>Categories:</strong> T-Shirts, Tops,
                                Mens
                              </span>
                            ...
                            <div className="details-row-2">
                              ...
                              <div className="right">
                                ...
                                <p className="mb--25">
                                  ...
                                  ultricies eget, tempor sit amet, ante. ibero
                                  sit amet quam egestas semperAenean ultricies
                                ...
                                <ul className="bottom-ul">
                                  ...
                                  <li>
                                    Habitasse venenatis gravida nisl,
                                    sollicitudin posuere
                                  </li>
                                </ul>
                              </div>
                            </div>
                        ...
                        <div>
                          <div className="single-tab-content-shop-details">
                            ...
                            <p className="cansellation mt--20">
                              <span> Return/cancellation:</span> No change will
                              be applicable which are already delivered to
                              customer. If product quality or quantity problem
                              found then customer can return/cancel their order
