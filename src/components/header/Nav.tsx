                    ...
                    <div className="col-lg-8">
                      <div className="megamenu-item-wrapper">
                        ...
                        <div className="single-megamenu-wrapper">
                          <p className="title">Breakfast & Dairy</p>
                          <ul>
                            <li>
                        ...
                        {/* single item areas start */}
                        <div className="single-megamenu-wrapper">
                          <p className="title">Meats & Seafood</p>
                          <ul>
                            <li>
                              <Link className="sub-b" href="/shop">
                                Frish
                              </Link>
                            </li>
                            <li>
                        ...
                        {/* single item areas start */}
                        <div className="single-megamenu-wrapper">
                          <p className="title">Biscuits and Snacks</p>
                          <ul>
                            <li>
                              <Link className="sub-b" href="/shop">
                                Biscuits
